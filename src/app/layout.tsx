...
export const metadata: Metadata = {
  ...
  description: "Expert hair transplant services in Kochi, Kerala. FUE, FUT, DHI, PRP treatments by Dr. Chacko Cyriac, MCh Plastic Surgery. 5000+ successful procedures, patients from 25+ countries.",
  keywords: [
