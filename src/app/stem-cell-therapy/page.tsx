  ...
  const advantages = [
    {
      ...
      description: "Stem cells improve graft survival rate from standard 60-70% to 85-90%, ensuring more transplanted hair survives and grows [web:230][web:232]"
    },
    {
      title: "Faster Healing & Recovery",
      description: "Regenerative properties accelerate wound healing. Most patients resume activities within 2-3 days vs 7-10 days with traditional FUE [web:232]"
    },
    {
      title: "Improved Hair Density",
      description: "45% increase in hair density compared to 25% with FUE alone. Stem cells stimulate dormant follicles to activate [web:230]"
    },
    {
      title: "Healthier Scalp Environment",
      description: "Stem cells promote neovascularization (new blood vessel formation) and reduce scalp fibrosis, creating optimal conditions for growth [web:230]"
    },
    {
      title: "Stimulates Existing Hair",
      description: "Not just transplanted follicles - nearby existing hair becomes thicker and healthier due to growth factor stimulation [web:232]"
    },
    {
      title: "Better Results on Scarred Tissue",
      description: "Particularly effective for repair cases or patients with scalp scarring from previous surgeries [web:230]"
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Small amount of adipose (fat) tissue or scalp tissue extracted using minor liposuction-like procedure or follicle collection [web:232]"
    },
    {
      step: "2",
      title: "Cell Processing & Isolation",
      description: "Harvested tissue processed with enzymes and centrifugation to isolate and concentrate stem/progenitor cells [web:232]"
    },
    {
      step: "3",
      title: "Nutrient-Rich Solution Preparation",
      description: "Isolated stem cells suspended in nutrient-rich solution, often mixed with bioactive factors from patient's own blood plasma [web:232]"
    },
    {
      step: "4",
    ...
    },
    {
      ...
      description: "Extracted follicles mixed with stem cell solution before implantation. Stem cell solution also injected into recipient area [web:232]"
    },
    {
      step: "7",
  ...
  const science = [
    {
      ...
      description: "Regenerative cells with ability to self-renew and develop into specialized cell types. They repair damaged tissues and stimulate cellular regeneration throughout the body [web:232]."
    },
    {
      title: "How They Help Hair Growth",
      description: "Stem cells secrete growth factors (VEGF, FGF, IGF) that promote blood vessel formation, activate dormant follicles, reduce inflammation, and create optimal environment for hair growth [web:230]."
    },
    {
      title: "Source of Stem Cells",
      description: "Autologous (patient's own) stem cells harvested from adipose tissue (fat), scalp tissue, or hair follicles. No rejection risk since they're from your own body [web:232]."
    },
    {
      title: "Safety & Ethics",
        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/services/fue" className="btn-secondary inline-block text-center border-white text-white hover:bg-white hover:text-gray-900">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-l-4 border-purple-600 p-6 rounded-r-lg mb-8">
              <div className="flex items-start gap-3">
                <Zap className="text-purple-600 flex-shrink-0 mt-1" size={28} />
                <div>
            ...
            <p className="text-lg text-gray-700 mb-4">
              Stem Cell FUE (Follicular Unit Extraction) is an advanced hair transplant technique that enhances traditional FUE with regenerative stem cell therapy [web:232]. The procedure extracts individual hair follicles from the donor area and enriches them with concentrated stem cells before implantation, while also injecting stem cell solution into the recipient scalp.
            </p>
            <p className="text-lg text-gray-700 mb-4">
              Unlike traditional FUE which simply moves hair follicles from one area to another, Stem Cell FUE actively stimulates the scalp's healing and regenerative processes [web:230]. The stem cells promote neovascularization (new blood vessel growth), reduce inflammation, and create an optimal environment for both transplanted and existing hair to thrive.
            </p>
            <p className="text-lg text-gray-700">
              Clinical studies demonstrate that stem cell therapy prior to FUE significantly improves outcomes: 87% graft survival vs 60% with FUE alone, and 45% density increase vs 25% [web:230]. At Eterno Clinic, Dr. Chacko Cyriac offers this cutting-edge treatment for patients seeking the absolute best hair restoration results.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Superior results backed by clinical research [web:230][web:232]
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {advantages.map((advantage, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-purple-600">
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Advanced 7-step procedure combining surgery and regenerative medicine [web:232]
            </p>
          </div>
          <div className="max-w-5xl mx-auto space-y-6">
            {process.map((item, index) => (
              <div key={index} className="flex gap-6 bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl shadow-lg">
                <div className="bg-gradient-to-br from-purple-600 to-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center font-bold text-2xl flex-shrink-0">
                  {item.step}
                </div>
                <div>
        ...
        <div className="container-custom">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8 text-center max-w-2xl mx-auto">
              See the measurable differences that make Stem Cell FUE worth the investment [web:230]
            </p>
              ...
              <table className="w-full bg-white rounded-xl shadow-lg">
                <thead>
                  <tr className="bg-gradient-to-r from-purple-100 to-blue-100">
                    ...
                    <th className="p-4 text-center font-bold text-purple-700">Stem Cell FUE</th>
                  </tr>
                </thead>
                <tbody>
                  {vsTraditional.map((row, index) => (
                    <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                      ...
                      <td className={`p-4 text-center ${row.advantage === 'traditional' ? 'bg-green-50 font-bold' : ''}`}>
                        {row.traditional}
                      </td>
                      <td className={`p-4 text-center ${row.advantage === 'stem' ? 'bg-purple-50 font-bold text-purple-700' : ''}`}>
                        {row.stemCell}
                      </td>
                    </tr>
                  ))}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-700 mb-2">
                Stem Cell FUE typically costs 30-50% more than traditional FUE due to additional processing, equipment, and expertise required. However, the superior results, faster healing, and better graft survival make it worthwhile for patients seeking optimal outcomes [web:232].
              </p>
              <p className="text-gray-700">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gradient-to-br from-purple-100 to-blue-100 p-6 rounded-xl shadow-lg">
              ...
              <div className="bg-gradient-to-br from-purple-100 to-blue-100 p-6 rounded-xl shadow-lg">
                <div className="text-4xl font-bold text-purple-700 mb-2">22+</div>
