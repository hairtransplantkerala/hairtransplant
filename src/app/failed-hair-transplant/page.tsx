...
export default function FailedHairTransplantRepairPage() {
  ...
  return (
    <>
        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 mb-4">
              <RefreshCw size={40} className="text-orange-300" />
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                <h3 className="text-xl font-bold mb-3 text-gray-900">{solution.title}</h3>
                <p className="text-gray-600 mb-4">{solution.description}</p>
                <div className="border-t pt-4">
                  <p className="text-sm text-orange-600 font-semibold">Technique: {solution.technique}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-orange-600 mb-3">Step 2</div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <div className="text-3xl font-bold text-orange-600 mb-3">Step 3</div>
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-orange-50 to-white p-8 rounded-2xl shadow-xl border border-orange-200">
