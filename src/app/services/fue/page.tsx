      ...
      <section className="relative bg-gradient-to-br from-gray-800 to-gray-900 text-white py-20">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-white mb-6">SC-FUE</h1>
      ...
      <section className="py-20">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold mb-4">Dr. Chacko Cyriac's Innovation</h3>
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 bg-gradient-to-r from-gray-100 to-gray-100 p-6 rounded-xl border-l-4 border-black">
